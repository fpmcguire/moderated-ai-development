...
Ceremonies are structured events that create rhythm, transparency, and shared understanding in a MAID team.
...
**Purpose:** Generate the step's artefacts using the AI agent under human guidance.
...
**Output:** Raw AI-generated artefacts ready for moderation
...
- Complete the [REVIEW.md](../templates/REVIEW.md) artefact
- Record moderation decisions and any concerns
- Accept, request revisions, or reject the output

**Output:** Completed REVIEW.md; accepted artefacts committed to the repository
