...
Quality gates are explicit, non-negotiable checkpoints that AI-generated artefacts must pass before they are accepted. Gates are defined per step in [STEP.md](../templates/STEP.md) and evaluated in [REVIEW.md](../templates/REVIEW.md).

---

## Gate Levels

MAID defines three levels of quality gate, applied according to the risk and complexity of the step.
...
Bypassing a gate — even under time pressure — introduces unverified AI output into the product and violates the [MAID Principles](principles.md).
