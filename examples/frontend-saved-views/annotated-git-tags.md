...
This document describes the git tagging convention used in this example project to mark the completion of each MAID step.

---

## Convention

Each completed step is tagged at the commit where its accepted artefacts were merged. Tags follow the format:
...
Annotated git tags serve several purposes in a MAID project:

1. **Traceability** — Any commit can be related back to the MAID step that produced it.
