...
This repository contains the **Moderated AI Development (MAID)** methodology framework — a structured approach to using AI models (such as ChatGPT and Claude) in software development under human moderation.
